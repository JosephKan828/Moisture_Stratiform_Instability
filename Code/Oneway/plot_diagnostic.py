...
# load data
file = "/home/b11209013/2025_Research/MSI/File/diagnose_oneway.h5"; 

with h5py.File(file, 'r') as f:
    λ = np.array(f.get("λ"));
    growth = np.array(f.get("growth_rate"));
    speed = np.array(f.get("phase_speed"));
    max_gr = np.array(f.get("max_growth"));
...
plt.plot(40000/λ, max_gr, label="Growth Rate", color='black');
...
plt.grid();
plt.savefig("/home/b11209013/2025_Research/MSI/Fig/Oneway_growth_rate.png", dpi=300);
plt.close()
...
plt.grid();
plt.savefig("/home/b11209013/2025_Research/MSI/Fig/Oneway_phase_speed.png", dpi=300);
plt.close()