...
with h5py.File("/home/b11209013/2025_Research/MSI/File/Full/reconstruction_rad.h5", "r") as f:
    ...
    R = np.transpose(np.array(f.get("R")).astype(np.complex64).real, axes=(1, 0, 2));          # (nt, nz, nx)
...
make_movie(
    ...
    out_path="/home/b11209013/2025_Research/MSI/Fig/Full/Temp_prof_rad.mp4",
)

make_movie(
    J, x, z,
    cmap="BrBG_r", title_prefix=r"$J^\prime$", units="K/day",
    out_path="/home/b11209013/2025_Research/MSI/Fig/Full/heat_prof_rad.mp4",
)

make_movie(
    R, x, z,
    cmap="BrBG_r", title_prefix=r"$R^\prime$", units="K/day",
    out_path="/home/b11209013/2025_Research/MSI/Fig/Full/rad_prof_rad.mp4",
)